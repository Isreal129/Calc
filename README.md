...
<body>
    <div class="bg-dark mx-auto text-center text-white" style="width:24rem; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Isreal Moses(212221040060)</div>
    <div class="my-3 row mx-auto text-center" style="width: 24rem; background: darkblue;">
